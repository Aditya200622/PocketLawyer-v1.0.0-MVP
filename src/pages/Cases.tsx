    ...
    <div className="space-y-5">
      ...
      {filtered.length === 0 && (
        <div className="rounded-xl p-12 text-center" style={{ background: '#FFFFFF', border: '1px solid #E5E7EB' }}>
          <div className="w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ background: '#F3F4F6' }}>
            <Briefcase className="h-6 w-6" style={{ color: '#9CA3AF' }} />
          </div>
          <p className="text-sm font-semibold text-gray-700">No matching cases</p>
          <p className="text-xs mt-1" style={{ color: '#9CA3AF' }}>Try adjusting your search or filters</p>
        </div>
      )}
